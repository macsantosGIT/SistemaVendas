    ...
    public partial class Usuario : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        PedidoDatEmissao = c.DateTime(nullable: false, precision: 0),
                        PedidoDatAlteracao = c.DateTime(nullable: false, precision: 0),
                        PedidoDesconto = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PedidoValor = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PedidoCondPagto = c.String(nullable: false, maxLength: 20, storeType: "nvarchar"),
                        ClienteId = c.Int(nullable: false),
                        FornecedorId = c.Int(nullable: false),
                        VendedorId = c.Int(nullable: false),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        PedidoDetalheItem = c.Int(nullable: false, identity: true),
                        PedidoDetalheQtd = c.Int(nullable: false),
                        PedidoDetalhePctDesc = c.Decimal(nullable: false, precision: 16, scale: 4),
                        PedidoDetalhePrecoUnit = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PedidoDetalhePrecoTotal = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PedidoId = c.Int(nullable: false),
                        ProdutoId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.PedidoDetalheItem)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TbPedido", "VendedorId", "dbo.TbVendedor");
            DropForeignKey("dbo.TbPedidoDetalhe", "ProdutoId", "dbo.TbProduto");
            DropForeignKey("dbo.TbPedidoDetalhe", "PedidoId", "dbo.TbPedido");
            DropForeignKey("dbo.TbPedido", "FornecedorId", "dbo.TbFornecedor");
            ...
            DropIndex("dbo.TbPedidoDetalhe", new[] { "ProdutoId" });
            DropIndex("dbo.TbPedidoDetalhe", new[] { "PedidoId" });
            DropIndex("dbo.TbPedido", new[] { "VendedorId" });
            DropIndex("dbo.TbPedido", new[] { "FornecedorId" });
